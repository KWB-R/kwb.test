test_that("create_test_files() works", {
  ...
  expect_error(.:::create_test_files())
})

test_that("get_code_to_test_source_file() works", {

  expect_error(.:::get_code_to_test_source_file())
})

test_that("get_function_assignments() works", {

  expect_error(.:::get_function_assignments())
})

test_that("get_test_for_function_assignment() works", {

  expect_error(.:::get_test_for_function_assignment())
})
